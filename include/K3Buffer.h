...
public:
     ...
     const char* overtextHist(const char*, float, float, float, const char*, float, float); /*!< formatted text overlay */
     const char* overtextTime(const char*, float, float, float, const char*, float, float); /*!< formatted text overlay */
